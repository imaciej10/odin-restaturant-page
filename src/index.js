...
import gallery1 from "./meal1.jpeg";
import gallery2 from "./meal2.jpg";
import gallery3 from "./kitchen1.jpeg";
import gallery4 from "./kitchen2.jpeg";
...
const loadPage = function () {
  ...
  cooksTitle.textContent = "Our amazing cooks";
...
const loadMenu = function () {
  ...
  menuContainer.appendChild(menuTitle, mealContainer);
  content.appendChild(menuContainer, socialContainer, footer);
};
...
const loadAbout = function () {
  ...
  mapImage.src = map;
  mapImage2.src = map2;
  aboutTitle.textContent = "Tiny Bites is here and boy it's here for good!";
...
const loadGallery = function () {
  ...
  title3.textContent = "Our kitchen";
  title4.textContent = "Our second";
